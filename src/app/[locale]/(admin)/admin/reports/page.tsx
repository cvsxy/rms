      ...
      {preset === "custom" && (
        <div className="flex items-center gap-3 mb-4">
          ...
          <input
            ...
            className="px-3 py-2 border border-gray-200 rounded-lg text-gray-900 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500"
          />
